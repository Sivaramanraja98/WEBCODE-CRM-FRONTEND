...
const LeadsList = () => {
    ...
    const getEmployees = () => {
        axios.get(`https://crmbackend-6tdy.onrender.com/api/get-all-leads`).then(response => {
    ...
    const deleteEmployee = (employeeId) => {
        axios.delete(`https://crmbackend-6tdy.onrender.com/api/delete-lead/${employeeId}`).then(response => {
            if (response) {
                getEmployees();
            }
        }).catch(err => {
